...
# Paths are relative to this script's location: scripts/analysis.py
...
WEBSITE_DATA = os.path.join(PROJECT_ROOT, "website", "data.json")
...
def main():
    ...
    company_metrics.to_csv(os.path.join(PROJECT_ROOT, "outputs", "company_metrics.csv"), index=False)
    sector_metrics.to_csv(os.path.join(PROJECT_ROOT, "outputs", "sector_metrics.csv"), index=False)
